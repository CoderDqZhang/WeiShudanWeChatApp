// pages/home/user_fans/user_fans.js
var app = getApp()
Page({
  ...
  user_info_tap: function(res){
    var that = this
    var data = that.data.fans_list[res.currentTarget.dataset.index]
  ...
  attention_tap: function (res) {
    var that = this
    var objectUser = that.data.fans_list[res.currentTarget.dataset.index]
    var data =
      {
